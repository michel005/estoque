        ...
        <AlternativeCalendarStyled className={"calendario " + (focusInput === true ? "" : "reduzido")}>
            <div className="campoLabel">
                ...
                <div className="inputIcon">
                    ...
                    <ButtonStyled onClick={eventoMostrarCalendario}>
            ...
            <div className="commandsAndCalendarViewer">
                <div className="commands">
                    <button title="Voltar 6 meses" onClick={() => anterior(6)}>
                        <FontAwesomeIcon icon={solid("arrow-circle-left")} />
                    </button>
                    <button title="Voltar 1 mês" onClick={() => anterior(1)}>
                        <FontAwesomeIcon icon={solid("arrow-left")} />
                    </button>
                    <div className="currentMonth">{(current.getMonth() + 1).toString().padStart(2, "0") + "/" + current.getFullYear()}</div>
                    <button title="Avançar 1 mês" onClick={() => proximo(1)}>
                        <FontAwesomeIcon icon={solid("arrow-right")} />
                    </button>
                    <button title="Avançar 6 meses" onClick={() => proximo(6)}>
                        <FontAwesomeIcon icon={solid("arrow-circle-right")} />
                    </button>
                </div>
                        ...
                        return (
                            <div key={i} className="week">
                                {weekCount.map((coluna) => {
                                    ...
                                    if (linha === 1 && dayList[index] !== undefined) {
                                        if (coluna === dayList[index].getDay() + 1) {
                                            if (dayList[index].getMonth() !== current.getMonth()) {
                                                return (
                                                    <div key={linha + "-" + coluna} className="day disabled">
                                                        {dayList[index].getDate()}
                                                    </div>
                                                );
                                            } else {
                                                return (
                                                    <div
                                                        key={linha + "-" + coluna}
                                                        onClick={() => mudarDiaAtual(dayList[index])}
                                                        className={
                                                            "day " +
                                                            (selectedDate !== null && mesmoDia(dayList[index], selectedDate) ? "current" : "") +
                                                            " " +
                                                            (dayList[index].toLocaleDateString() === new Date().toLocaleDateString() ? "today" : "")
                                                        }
                                                    >
                                                        {dayList[index].getDate()}
                                                    </div>
                                    ...
                                    } else if (dayList[index] !== undefined) {
                                        if (coluna === dayList[index].getDay() + 1) {
                                        ...
                                        return dayList[index] !== undefined ? (
                                            <div
                                                key={linha + "-" + coluna}
                                                onClick={() => mudarDiaAtual(dayList[index])}
                                                className={
                                            ...
                                            <div key={linha + "-" + coluna} className="day disabled"></div>
                                        );
                                    }
                                    return coluna;
                                })}
